...
const TimelineCard = ({
  ...
  return (
    <div
      ref={containerRef}
      className={`grid-auto-rows my-4 mx-0 grid
    ...
    >
      ...
      <h4 className="col-start-1 col-end-2 my-2 w-2/3 justify-self-center rounded bg-gradient-to-tr from-green-700 to-green-500 p-1 text-center font-normal text-white shadow-md shadow-green-100 dark:shadow-slate-900">
        {entry.date}
      </h4>
      ...
      <h3 className="col-start-4 col-end-6 mr-8 text-right font-light italic dark:text-slate-800">
        {entry.description}
      </h3>
...
const Method = (props: ITimelineEntryMethod) => {
  ...
  return (
    <div className="prose flex h-full flex-col justify-evenly">
...
const ProjectStatus = (props: ITimelineEntryStatus) => {
  return (
    <div className="prose flex h-full flex-col justify-evenly border-l border-slate-400 pl-4 dark:border-slate-600">
      {Object.entries(props).map(([name, text]) => (
        <div key={name}>
